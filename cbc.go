...
func main() {
	...
	fmt.Println("密文", hex.EncodeToString(result))
	// 0605fda3e80da8724d66811725a98f961bf3ca2e1fadf6af8f7223425c74bc69

	fmt.Println("base64编码密文", base64.StdEncoding.EncodeToString(result))
	// BgX9o+gNqHJNZoEXJamPlhvzyi4frfavj3IjQlx0vGk=

	// 解密
	fmt.Println("明文", string(CBCDecrypter(result, key, iv)))
}
